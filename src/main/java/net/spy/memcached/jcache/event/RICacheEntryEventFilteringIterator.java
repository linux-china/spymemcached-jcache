...
/**
 * A adapter to {@link java.util.Iterator}s to allow filtering of {@link javax.cache.event.CacheEntryEvent}s
 *
...
public class RICacheEntryEventFilteringIterator<K, V> implements Iterator<CacheEntryEvent<K, V>> {
  ...
  /**
   * The filter to apply to Cache Entry Events in the {@link java.util.Iterator}.
   */
