...
public class RICacheEntryListenerFactoryDefinition<K, V> implements CacheEntryListenerConfiguration<K, V> {
   ...
   *
   * @param listenerFactory    the {@link javax.cache.event.CacheEntryListener} {@link javax.cache.configuration.Factory}
   * @param filterFactory      the optional {@link javax.cache.event.CacheEntryEventFilter} {@link javax.cache.configuration.Factory}
