...
package net.spy.memcached.jcache.event;
...
/**
 * An internal structure to represent the registration of a {@link javax.cache.event.CacheEntryListener}.
 *
...
public class RICacheEntryListenerRegistration<K, V> {
  ...
  /**
   * Obtains the {@link javax.cache.event.CacheEntryListener} that was registered.
   *
   * @return the {@link javax.cache.event.CacheEntryListener}
   */
  ...
  /**
   * Obtains the {@link javax.cache.event.CacheEntryEventFilter} that was registered.
   *
   * @return the {@link javax.cache.event.CacheEntryEventFilter}
   */
